...
summary:
  problem: "New managers were promoted on technical chops, then handed a leadership Learning Management System (LMS) path and a 'good luck.' 65% reported feeling unprepared at the 90-day check-in."
  ...
  outcome: "90-day 'feel prepared' scores climbed from 35% → <b>82%</b>, and the cohort design became the default for every leadership level above."
order: 4
...
<ProcessDiagram
  ...
  accent="vermillion"
  caption="Eight weeks, three rhythms — and one capstone that decides whether judgment actually shifted."
  steps={[
    { num: '01', label: 'Kickoff',     desc: 'Cohort sets expectations + names one real decision each member will eventually defend.' },
    { num: '02', label: 'Async core',  desc: 'Twice-weekly micro-lessons (15–20 min) on feedback, escalation, hiring, performance.' },
    { num: '03', label: 'Friday live', desc: 'Ninety-minute live coaching: case discussion, peer-coaching, or manager autopsy.' },
    { num: '04', label: 'Capstone',    desc: 'Each manager walks the cohort through their decision and fields fifteen minutes of questions.' },
  ]}
/>
...
Ninety-day "feel prepared" scores climbed from thirty-five to eighty-two percent across the first three cohorts.

<BigStat
  size="lg"
  accent="vermillion"
  value="82%"
  label="Feel-prepared at 90 days"
  delta={{ direction: 'up', amount: '+47pt', label: 'vs 35% baseline' }}
/> More importantly, the *retention of new managers* through their first year improved meaningfully — and the cohort design became the default for every leadership level above (senior manager, director, VP) within twelve months.
